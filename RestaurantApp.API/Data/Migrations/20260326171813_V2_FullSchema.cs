...
{
    /// <inheritdoc />
    public partial class V2_FullSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchId = table.Column<Guid>(type: "uuid", nullable: true, comment: "NULL = áp dụng cho tất cả chi nhánh"),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Giờ thực tế nhân viên vào ca (chấm công)"),
                    ActualEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Giờ thực tế nhân viên kết thúc ca"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Thời điểm khách muốn đến"),
                    Note = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentToKitchenAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Thời điểm nhân viên gửi món vào bếp"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferredAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Thời điểm chuyển bàn"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    ReceivedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Thời điểm ticket xuất hiện ở bếp"),
